...
;;Language Tool
(setq langtool-language-tool-jar "C:/Programms/LanguageTool-6.3/languagetool-commandline.jar")
(require 'langtool)
...
#+AUTHOR: Simon Engel
#+SETUPFILE: C:/Users/Simon/AppData/Roaming/.config/emacs/setup.org")
  (backward-char))
